...
const seedModels = [
  ...
  },
  {
    ...
    priceEth: 0.48,
    price: eth(0.48),
    image: "/assets/hero-portrait.svg",
    description:
...
function createModel(input) {
  ...
  const model = {
    ...
    image: input.image || "/assets/network-sphere.svg",
